        ...
        foreach (Control control in controls)
        {
            switch (control)
            {
                case Button button:
                    ...
                    button.BackColor = button.Text.Contains("Add", StringComparison.OrdinalIgnoreCase) || button.Text.Contains("Approve", StringComparison.OrdinalIgnoreCase) ? Success : AccentDark;
